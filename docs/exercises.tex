...
A Docker image is provided with MadGraph, the CUDACPP plugin, the FlameGraph tools, and \perf pre-installed, and can be downloaded from \href{url}{this link}.
This is the recommended setup if you do not have a native Linux machine.
...
You can check that the following options have been set (before running the container): \texttt{sysctl kerne.perf\_event\_paranoid} should return \texttt{-1};
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Identify} the bottleneck and quantify its weight.
    \item \textbf{Predict} speedups using Amdahl's law.
    \item \textbf{Verify} with hardware performance counters.
...
Profiling again at the end of any kind of optimisation work is essential to be able to understand what actually changed, if performances changes, and whether new bottlenecks have appeared.
...
\begin{itemize}[nosep]
    \item Brendan Gregg, \emph{Flame Graphs}: \url{https://www.brendangregg.com/flamegraphs.html}
    \item FlameGraph tools: \url{https://github.com/brendangregg/FlameGraph}
    \item MG5aMC repository: \url{https://github.com/mg5amcnlo/mg5amcnlo}
    \item MadGraph4GPU repository: \url{https://github.com/madgraph5/madgraph4gpu}
    \item A.~Valassi et al., \emph{Madgraph on GPUs and vector CPUs: towards production}, arXiv:2503.21935
    \item A.~Valassi, \emph{New GPU developments in the Madgraph CUDACPP plugin}, arXiv:2510.05392
    \item \texttt{perf} wiki: \url{https://perf.wiki.kernel.org/index.php/Tutorial}
\end{itemize}
